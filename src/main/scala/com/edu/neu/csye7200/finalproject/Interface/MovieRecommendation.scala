...
object MovieRecommendation {
  ...
  /**
    ...
    */
    ...
    def searchByName(content: String): Array[(Int, String, String, String, Int, String, Float)] = {
      val df = DataUtil.getBookRatingData()
      val book = QueryUtil.searchByName(df, content.trim.toLowerCase)
      book
    }
    def searchByISBN(content: String): Array[(Int, String, String, String, Int, String, Float)] = {
      val df = DataUtil.getBookRatingData()
      val book = QueryUtil.searchByISBN(df, content.trim.toLowerCase)
      book
    }
    def searchByAuthor(content: String): Array[(Int, String, String, String, Int, String, Float)] = {
      val df = DataUtil.getBookRatingData()
      val book = QueryUtil.searchByAuthor(df, content.trim.toLowerCase)
      book
    }
    def searchByPublisher(content: String): Array[(Int, String, String, String, Int, String, Float)] = {
      val df = DataUtil.getBookRatingData()
      val book = QueryUtil.searchByPublisher(df, content.trim.toLowerCase)
      book
    }
}
